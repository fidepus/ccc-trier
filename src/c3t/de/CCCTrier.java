...

{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tabHost.addTab(tabHost.newTabSpec("1").setIndicator("News", getResources().getDrawable(R.drawable.ic_tab_news)).setContent(new Intent(this, NewsActivityGroup.class)));
